...
<body style="background-color: #EEEEEE;">
				...
				<div class="col-md-12 column">
					<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
						<div class="navbar-header">
							 ...
							 <a class="navbar-brand" href="index.jsp" style="color:black; font-size:25px;">在线考试系统</a>
						</div>
								...
								<li class="dropdown">
									 ...
									 <c:if test="${sessionScope.loginStudent == null }">
										<div class="btn-group" style="margin-top: 5px;">
											<button type="button" class="btn btn-default btn-sm" id="studentLogin1">登录</button>
											<button type="button" class="btn btn-default btn-sm" id="studentRegister">注册</button>
											<a href="admin/login.jsp" target="_blank" class="btn btn-default btn-sm" id="studentLogin">后台管理入口</a>
										</div>
									 </c:if>
								</li>
							</ul>
	...
	<script type="text/javascript">
		$(function() {
			$("#examCenter-link, #mineCenter-link, #video-link").click(function() {
				//判断是否登录
